...
import { Download, Edit, Trash2, FileText, File, MoreVertical, Pencil } from 'lucide-react';
...
const EnhancedFileItem: React.FC<EnhancedFileItemProps> = ({ 
  ...
  return (
    <>
      <Card className={`hover:bg-accent/50 transition-colors ${isSelected ? 'ring-2 ring-primary' : ''}`}>
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              {isRenaming ? (
                ...
                <div className="flex items-center gap-2">
                  <h3 className="font-medium text-foreground text-sm sm:text-base truncate flex-1">
                    {file.name}
                  </h3>
                  <Button
                    variant="ghost"
